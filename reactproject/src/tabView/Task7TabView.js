...
import Task7Form from './Task7Form';
...
class Task7TabView extends React.Component {
  state = {
    value: 0,
    empId:'',
    action:'',
...
render() {
    ...
    return (
      <div className={classes.root}>
        ...
        {value === 0 && <Task7Form dataForEdit = {this.state}/>}
        {value === 1 && <Task7DBtable hover={this.hover} hoverValue={this.state.hover} getIdEvent={this.getIdEvent} deleteEvent={this.RemoveEvent}/>}
      </div>
    );
  }
}

Task7TabView.propTypes = {
  classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(Task7TabView);
