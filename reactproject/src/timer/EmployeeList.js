...
import EmployeeEDbuttons from './EmployeeEDbuttons';
import '../Task.css';
        ...
        <TableBody>
          {dbData.map((n,index) => {
            ...
            onMouseLeave={(e)=>props.hover(e,-1)}>
                ...
                <CustomTableCell >{(props.hoverValue == index )?<EmployeeEDbuttons id={n.Id} getIdEvent={props.getIdEvent} deleteEvent={props.deleteEvent} />:''}</CustomTableCell>
              </TableRow>
            );
          })}
        </TableBody>
